import type { ModelSettings } from 'untitled-pixi-live2d-engine'

import JSZip from 'jszip'

import { CubismModelSettings, ZipLoader } from 'untitled-pixi-live2d-engine'

ZipLoader.zipReader = (data: Blob, _url: string) => JSZip.loadAsync(data) as any
...
function createFakeSettings(files: string[]): ModelSettings {
  ...
  const settings = new CubismModelSettings({
